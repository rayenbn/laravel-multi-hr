    ...
    <span class="btn btn-primary btn-xs" data-dismiss="modal"><i class="fa fa-times"></i> Chiudi</span>
						...
						<div class="ace-settings-container" id="ace-settings-container">
                          ...
                          <div class="ace-settings-box clearfix" id="ace-settings-box">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="page-header"><h1><i class="fa fa-table"></i> Turnazione<span class='label label-lg label-pink arrowed-in arrowed-in-right'> Gestione Turni</span></h1></div>
...
<div class="col-md-3">Settimana:</div>
					<div class="col-md-3">
<div class="form-group">
<input type="text"  class="form-control input-datepicker"  id="TNR_DTA_STR" NAME="TNR_DTA_STR" placeholder="Dalla Data"><i class="fa fa-table"></i>
<small>gg/mm/aaaa</small>
</div>
</div>
<div class="col-md-3">
<div class="form-group">
<input type="text"  class="form-control input-datepicker"  id="TNR_DTA_END" NAME="TNR_DTA_END" placeholder="Alla Data"><i class="fa fa-table"></i>
<small>gg/mm/aaaa</small>
</div>
</div>
            ...
            <div class="space-2"></div>
			<div><br><center><input class="btn btn-primary" type="submit" name="visualize" value="VISUALIZZA" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"/></center></div>
            <div class="collapse" id="collapseExample"  >
			
			<div id="anadiplstLoad">
				<?php if (isset($_POST['visualize']))
				{if (empty($_POST['usr_username']) || empty($_POST['TNR_DTA_STR']) || empty($_POST['TNR_DTA_END']))
			...
			<h4 class="col-12">Personale disponible</h4>
...
{
 ?>
<div class="list-group-item"><?php echo"{$row['name_emp']}</div>";
}?>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
       <thead>
<tr><th class="text-left">Profilo professionale</th></tr>
<tr>

<th class="text-left">Lavapiatti</th>
<th class="text-center">lun<br> 11/11/2019</th>
<th class="text-center">mar<br> 12/11/2019</th>
<th class="text-center">mer<br> 13/11/2019</th>
<th class="text-center">gio<br> 14/11/2019</th>
<th class="text-center">ven<br> 15/11/2019</th>
<th class="text-center">sab<br> 16/11/2019</th>
<th class="text-center">dom<br> 17/11/2019</th>
<th class="text-center">tot.Hh</th>
...
<?php 
$queryy="select * from emp Where task_emp='LAVAPIATTI'";
$result=mysqli_query($con,$queryy);
while($row= mysqli_fetch_assoc($result))
{
...
<img class="img img-circle" style="width:24px;height:24px" src="img/man.png"><?php echo"{$row['name_emp']}</td>";
echo"<td>08:30 - 12:30</td>";
echo"<td>RIPOSO</td>";
echo"<td>20:00 - 24:00</td>";
echo"<td>RIPOSO</td>";?>
<td class="text-center">08:30 - 12:30</td>
<td class="text-center">RIPOSO</td>
<td class="text-center">08:30 - 12:30</td>
<td class="text-center">16</td>

<?php echo "</tr>"; }?>
<tfoot><tr><td></td><td>total</td><td>total</td><td>total</td><td>total</td><td>total</td><td>total</td><td>total</td><td>total</td></tr></tfoot>
     </tbody>
    </table>
	

<center><input type="submit" name="salva" value="salva" class="btn btn-primary"></center>
...
$(".menu_sidebar"). click(function(){
 ...
 <script src="../dist/sortable/Sortable.js"></script>
<script type="text/javascript" src="../dist/sortable/st/prettify/prettify.js"></script>
<script type="text/javascript" src="../dist/sortable/st/prettify/run_prettify.js"></script>

	<script src="../dist/sortable/st/app.js"></script>	
	<script type="text/javascript">
